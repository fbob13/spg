        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="row row-cards">
              <?php if ($this->session->userdata('spc') == 0) {
              ?>
                <div class="col-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="d-flex">
                        <h3 class="card-title">Grafik pekerjaan rutin hari ini</h3>
                      </div>
                      <div id="chart-rutin-pie"></div>
              ...
              <?php
              if ($this->session->userdata('spc') == 2 or $this->session->userdata('spc') == 1 or $this->session->userdata('spc') == 99) {
                echo '<div class="col-12">';
              } else if ($this->session->userdata('spc') == 0) {
