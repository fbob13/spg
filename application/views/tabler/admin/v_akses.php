                ...
                <div class="table-responsive p-3">
                    <table class="table table-vcenter text-wrap table-bordered" id='postsList' width="100%" cellspacing="0">
                        ...
                        <tbody id="tabel-body">
                            ...
                            <tr>
                                <td class="text-center">4</td>
                                <td>Pimpinan / Kepala Seksi</td>
                                <td>Untuk Pimpinan</td>
                                <td><a href="#" class="btn btn-icon text-primary btn-light" c-aksi="update" c-spc=3><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            <path d="M9 7h-3a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-3" />
                                            <path d="M9 15h3l8.5 -8.5a1.5 1.5 0 0 0 -3 -3l-8.5 8.5v3" />
                                            <line x1="16" y1="5" x2="19" y2="8" />
